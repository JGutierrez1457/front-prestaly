...
function Home() {
    ...
    return (
        <div>
            <img src={process.env.PUBLIC_URL + '/prestalytitle.png'} alt='Prestaly' className={classes.imagePrestaly} />
            <Typography variant='h6' align='center' style={{ margin: '0 4px' }} > Una aplicación pensada para los prestamos en una familia.👨‍👩‍👧‍👦💰 </Typography>
            <div className={classes.buttons}>
                <Button component={Link} to='/login' className={classes.bttnLogin} size='small' variant='contained'>Ingresar</Button>
                <span>o</span>
                <Button component={Link} to='/login' style={{ backgroundColor: '#FFFFFF' }} size='small' variant='contained'>Registrarse</Button>
            </div>
            <footer className={classes.footer}>
                <a href="https://github.com/JGutierrez1457" target='_blank' rel="noreferrer">
                ...
                <a href="mailto:jgutierrezch@uni.pe" target='_blank' rel="noreferrer">
                <svg className={classes.logoGmail} width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  fill-rule="evenodd" clip-rule="evenodd"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm0 2c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm5.144 14.5h-10.288c-.472 0-.856-.384-.856-.856v-6.788c0-.472.384-.856.856-.856h10.288c.472 0 .856.384.856.856v6.788c0 .472-.384.856-.856.856zm-5.144-3.043l-4.671-3.241-.01 5.784h9.342v-5.784l-4.661 3.241zm4.435-4.957h-8.895l4.46 3.115s3.126-2.203 4.435-3.115z"/></svg>
                </a>
                <a href="https://www.linkedin.com/in/jorge-gutierrez-chochoca-9a83b11b5/"  target='_blank' rel="noreferrer">
                <svg className={classes.logoIn} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-2 16h-2v-6h2v6zm-1-6.891c-.607 0-1.1-.496-1.1-1.109 0-.612.492-1.109 1.1-1.109s1.1.497 1.1 1.109c0 .613-.493 1.109-1.1 1.109zm8 6.891h-1.998v-2.861c0-1.881-2.002-1.722-2.002 0v2.861h-2v-6h2v1.093c.872-1.616 4-1.736 4 1.548v3.359z" /></svg>
                </a>
            </footer>
        </div>
    )
