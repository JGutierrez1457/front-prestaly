    ...
    return (
        <div>
            ...
            <div className={classes.buttons}>
                ...
                <span>o</span>
                <Button component={Link} to='/signup' style={{ backgroundColor: '#FFFFFF' }} size='small' variant='contained'>Registrarse</Button>
            </div>
