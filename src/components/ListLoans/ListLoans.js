    ...
    if (family.no_balanceds && family.no_balanceds.length !== 0) {
        return <div className={classes.containerLoans}>
            {family.no_balanceds.map(
                ...
                return <Accordion key={index} square expanded={expandedLoan === loan._id} onChange={handleExpanded(loan._id)} >
                    ...
                    <AccordionDetails style={{display:'block'}}>
                        <Loan key={index} {...loan} family={family} handleUpdateLoan={handleUpdateLoan} />
                    </AccordionDetails>
